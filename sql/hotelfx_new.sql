...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 16. Jan 2020 um 22:35
...
(1, '2020-01-16 21:22:36', 'PAYPAL', 6, 2, 1),
(2, '0000-00-00 00:00:00', 'CASH', 3, 1, 1),
(3, '0000-00-00 00:00:00', 'BTRF', 23, 3, 1),
(4, '0000-00-00 00:00:00', 'BTRF', 24, 3, 1),
(5, '2020-01-16 21:23:07', 'PAYPAL', 25, 2, 1);
...
(1, 'PRIME', 'prime equipment', 1),
(2, 'COMFORT', 'comfot equipment', 1),
(3, 'STANDARD', 'standard equipment', 1),
(4, 'BASIC', 'basic equipment', 1);
...
--
ALTER TABLE `roomsbooked`
  MODIFY `roomsBookedID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
